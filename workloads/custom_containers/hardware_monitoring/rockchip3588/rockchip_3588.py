...
class RockChipData():
    ...
    def get_load_average(self):
        ...
        five_minute_average = round((load_tuple[1] * self.core_count), 2)
        fifteen_minute_average = round((load_tuple[2] * self.core_count), 2)
    ...
    def ethernet_data(self, INTERFACE_NAME):
        ...
        return psutil.net_if_stats()[INTERFACE_NAME].speed
